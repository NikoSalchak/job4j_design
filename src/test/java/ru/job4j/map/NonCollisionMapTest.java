...
class NonCollisionMapTest {
    ...
    @Test
    void whenPutAndGeTAnotherValue() {
        map.put(4, "value");
        map.put(20, "value");
        assertThat(map.get(4)).isEqualTo("4");
        assertThat(map.get(20)).isEqualTo(null);
    }

    @Test
    void whenPutAndFalse() {
        assertThat(map.put(3, "3")).isFalse();
        assertThat(map.put(4, "value")).isFalse();
        assertThat(map.put(20, "value")).isFalse();
    }
    ...
    void whenPutAndGet() {
        ...
        map.put(10, "value");
        assertThat(map.get(4)).isEqualTo("4");
        assertThat(map.get(5)).isEqualTo("value");
        assertThat(map.get(6)).isEqualTo("value");
    }
    ...
    void whenRemoveIsFalse() {
        ...
        assertThat(map.remove(20)).isFalse();
    }
